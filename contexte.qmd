...
Dans les années 70 certains articles (@freedman1977) mentionnent que lorsque nous considèrons un modèle avec deux zones et dans chaque zone une population qui échange avec l'autre librement des individus, alors la somme des équilibres est le plus souvent différente de celle qu'elle serait si il n'y avait qu'une zone.

C'est ce que nous appellons le débat [SLOSS](https://en.wikipedia.org/wiki/SLOSS_debate) (Single Large Or Several Small). Nous diront qu'une population structurée est caractérisée par un phénomène d'inflation si la somme de ses équilibres est plus grande que l'équilibre s'il n'y avait qu'une structure (et l'inverse pour la déflation).
