...
En effet, la taille des mailles de la grille permet de cloisonner près de 100% des ravageurs et libérer jusqu'à 98% des prédateurs (Deguine et al., 2011).
...
Le modèle final est un modèle [proie-prédateur](https://fr.wikipedia.org/wiki/%C3%89quations_de_pr%C3%A9dation_de_Lotka-Volterra) en deux structures avec de la migration assymétrique entre chaque structure.
