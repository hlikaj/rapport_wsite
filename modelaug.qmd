...
fig01 = """
<iframe width="700" height="550" src="https://www.geogebra.org/classic/bw3wqnzg" style="overflow: hidden border: 1px solid black" scrolling="no"></iframe>
"""
display.HTML(fig01)
```
...
On verra dans la suite que la condition ([-@eq-app2]) est l'invasion des prédateurs.
